...
class Window extends Component {
  ...
  componentDidMount () {
    let height = this.props.div ? window.innerHeight / this.props.div : this.props.add ? window.innerHeight + this.props.add : window.innerHeight;
...
class Grid extends Component {
  ...
  render(){
    return (
      <div className={`container ${this.props.className || ""}`} id={this.props.id || ""}>
        {this.props.children}
      </div>
    )
  }
